#!/bin/bash
#set -ex
# Below images NO NEED to migrate
## ssp:        https://github.com/seoktaehyeon/docker-self-service-password
## jira:       https://github.com/seoktaehyeon/docker-jira-software
## confluence: https://github.com/seoktaehyeon/docker-confluence-server
## jenkins:    https://github.com/seoktaehyeon/docker-jenkins
...
cd ${root_dir}/odo-portal/dockerBuild && docker build -t ${target_img} . && docker push ${target_img}

target_img="${registry}/${repo}/odo-msg:latest"
cd ${root_dir}/odo-msg/dockerBuild && docker build -t ${target_img} . && docker push ${target_img}
